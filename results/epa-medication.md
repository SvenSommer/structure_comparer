...
| Medication.amount | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
...
| Medication.amount.numerator.extension.id | X |  | X | X |  | Extension und Values werden übernommen |
...
| Medication.amount.numerator.extension.value[x].slice($this) | X |  | X | X |  | Extension und Values werden übernommen |
...
| Medication.batch.id | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
...
| Medication.code.coding.id | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.code.coding.slice($this) | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
...
| Medication.code.id | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.code.text | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.contained | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
...
| Medication.extension.id | X | X | X | X |  | Extension und Values werden übernommen |
...
| Medication.extension.value[x].coding.id | X | X | X | X |  | Extension und Values werden übernommen |
| Medication.extension.value[x].coding.system | X | X | X | X |  | Extension und Values werden übernommen |
| Medication.extension.value[x].coding.userSelected | X | X | X | X |  | Extension und Values werden übernommen |
| Medication.extension.value[x].coding.version | X | X | X | X |  | Extension und Values werden übernommen |
| Medication.extension.value[x].display | X | X | X | X |  | Extension und Values werden übernommen |
| Medication.extension.value[x].extension | X | X | X | X |  | Extension und Values werden übernommen |
| Medication.extension.value[x].id | X | X | X | X |  | Extension und Values werden übernommen |
| Medication.extension.value[x].slice($this) | X | X | X | X |  | Extension und Values werden übernommen |
| Medication.extension.value[x].system | X | X | X | X |  | Extension und Values werden übernommen |
| Medication.extension.value[x].text | X | X | X | X |  | Extension und Values werden übernommen |
| Medication.extension.value[x].userSelected | X | X | X | X |  | Extension und Values werden übernommen |
| Medication.extension.value[x].version | X | X | X | X |  | Extension und Values werden übernommen |
...
| Medication.extension:Kategorie(https://fhir.kbv.de/StructureDefinition/KBV_EX_Base_Medication_Type&#124;1.3.0) | X | X | X | X |  | Extension und Values werden übernommen |
...
| Medication.form.coding.id | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.form.coding.slice($this) | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
...
| Medication.form.id | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.form.text | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.id | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.identifier | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.identifier.slice($this) |  |  |  |  | X |  |
| Medication.implicitRules | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.ingredient | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
...
| Medication.ingredient.extension.id | X |  |  |  |  | Extension und Values werden übernommen |
...
| Medication.ingredient.extension.value[x].slice($this) | X |  |  |  |  | Extension und Values werden übernommen |
...
| Medication.ingredient.id | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.ingredient.isActive | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
...
| Medication.ingredient.item[x].coding.id | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.ingredient.item[x].coding.slice($this) | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
...
| Medication.ingredient.item[x].id | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
...
| Medication.ingredient.item[x].slice($this) | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
...
| Medication.ingredient.strength.denominator.code | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.ingredient.strength.denominator.comparator | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.ingredient.strength.denominator.extension | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.ingredient.strength.denominator.id | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.ingredient.strength.denominator.system | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.ingredient.strength.denominator.unit | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
...
| Medication.ingredient.strength.extension.id | X |  |  |  |  | Extension und Values werden übernommen |
...
| Medication.ingredient.strength.extension.value[x].slice($this) | X |  |  |  |  | Extension und Values werden übernommen |
...
| Medication.ingredient.strength.id | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
...
| Medication.ingredient.strength.numerator.comparator | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.ingredient.strength.numerator.extension | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.ingredient.strength.numerator.id | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
...
| Medication.language | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.manufacturer | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
...
| Medication.status | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
| Medication.text | X | X | X | X | X | Eigenschaft und Wert werden übernommen |
