...
<style>
    ...
    .compTable tr:nth-child(54) { background: lightcyan; }
    ...
    .compTable tr:nth-child(60) { background: lightcyan; }
    ...
    .compTable tr:nth-child(78) { background: lightcyan; }
    .compTable tr:nth-child(79) { background: lightgreen; }
    ...
    .compTable tr:nth-child(84) { background: lightcyan; }
