## Comparison: KBV_PR_ERP_Medication_Compounding.json, KBV_PR_ERP_Medication_FreeText.json, KBV_PR_ERP_Medication_Ingredient.json, KBV_PR_ERP_Medication_PZN.json vs epa-medication.json
| Property | ePA | KBV_PR_ERP_Medication_Compounding.json | KBV_PR_ERP_Medication_FreeText.json | KBV_PR_ERP_Medication_Ingredient.json | KBV_PR_ERP_Medication_PZN.json |
|---|---|---|---|---|---|
...
| Medication.extension.value[x].display |  | X | X | X | X |
...
| Medication.ingredient.extension.extension |  | X |  |  |  |
...
| Medication.ingredient.strength.denominator.id | X | X | X | X | X |
...
## Comparison: KBV_PR_FOR_Practitioner.json vs PractitionerDirectory.json
| Property | ePA | KBV_PR_FOR_Practitioner.json |
|---|---|---|
| Practitioner | X | X |
...
| Practitioner.name.family.extension.id |  | X |
...
| Practitioner.qualification.code.coding.id |  | X |
...
## Comparison: KBV_PR_ERP_Prescription.json vs epa-medication-request.json
| Property | ePA | KBV_PR_ERP_Prescription.json |
|---|---|---|
...
| MedicationRequest.dispenseRequest.dispenseInterval | X | X |
...
| MedicationRequest.dosageInstruction.extension.extension |  | X |
...
| MedicationRequest.extension.extension.value[x].denominator.id |  | X |
...
| MedicationRequest.extension.value[x].system |  | X |
...
## Comparison: KBV_PR_FOR_Organization.json vs OrganizationDirectory.json
| Property | ePA | KBV_PR_FOR_Organization.json |
|---|---|---|
| Organization | X | X |
...
| Organization.contact.modifierExtension | X | X |
